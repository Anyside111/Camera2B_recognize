...
//Fragment represents a behavior or a portion of the user interface in an activity
class ImageViewerFragment : Fragment() {
    ...
    //creates and returns an ImageView with layout parameters
    ...
    //sets up the ViewPager2 and loads images into it
    //call for addItemToViewPager
    //main function: initializes the view and starts the process of loading images
    ...
    //A companion object in Kotlin is an object that is common to all instances of a class
    companion object {
